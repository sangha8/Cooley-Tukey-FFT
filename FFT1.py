...
x += np.sin((2*np.pi*x_values / 8.0)) # 16 - 1024Hz
...
plt.annotate('256',(256,1))
plt.annotate('1024',(1024,1))        

#The next line can be used to check that correct frequencies are being resolved                         # <--
